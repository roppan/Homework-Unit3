...
with open (budget_data_csv,'r', encording='utf-8') as f:
    ...
    for row in csv_reader:
        ...
        if  net_change < greateest_sd_decrease[1]:
...
net_average = sum(net_change_list) / len(net_chang_list)
...
print(f"Average Change:{net_average change}")
print(f"Greatest Increase in Profits: {greatest_sd_increase}")
print(f"Greatest Decrease in Profits: {greatest_sd_decrease}")
